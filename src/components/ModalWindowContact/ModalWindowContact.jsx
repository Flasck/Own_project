        ...
        return <>
            <div className={statusModalView ? styles.modal_active : styles.modal} onClick={() => {dispatch(FeedbackSlice.actions.changeView());
                ...
                <div className={styles.content} onClick={(e) => {e.stopPropagation()}}>
                    ...
                    <Button onClick={()=>{dispatch(FeedbackSlice.actions.changeStatus(Statuses.idle));dispatch(FeedbackSlice.actions.changeView())}} className={classnames(styles.btn, styles.btn_status)}>Ок</Button>
                </div>
            </div>
        </>
    }
            ...
            <div className={styles.content} onClick={(e) => {e.stopPropagation()}}>
                        ...
                        <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className={styles.wrapper}>
                                <Button disabled={!isValid || !CheckBox} type="submit" className={styles.btn}>Отправить</Button>
                            </div>
                        </form>
            </div>
        </div>
