                ...
                <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
                    ...
                    >
                        ...
                        <label className={styles.label}>
                            ...
                            <Link onClick={(e) => e.stopPropagation()} target='_blank' to={"/personalData"}
                                  className={styles.label__link}>{texts?.mainPage?.modalWindowContact?.checkBoxLabel.split(" ").slice(-2)?.join(" ")}</Link>
                        </label>
                    </div>
