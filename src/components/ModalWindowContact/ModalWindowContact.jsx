            ...
            <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
                <div className={styles.form__block}>
                    <label className={styles.label}
                           htmlFor="input_author">{texts?.mainPage?.modalWindowContact?.author?.text}</label>
                    <input
                        {...register("author", {
                ...
                <div className={styles.form__block}>
                    <label className={styles.label}
                           htmlFor="input_email">{texts?.mainPage?.modalWindowContact?.email?.text}</label>
                    <input
                        {...register("email", {
                ...
                <div className={styles.form__block} style={{marginBottom: "35px"}}>
                    <label className={styles.label}
                           htmlFor="input_text">{texts?.mainPage?.modalWindowContact?.text?.text}</label>
                    <textarea
                        {...register("text", {
